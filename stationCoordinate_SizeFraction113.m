...
sf113 = readtable('Anomaly_SizeFraction_113_v2',VariableNamingRule='preserve') % dataframe generate in anomaly_SizeFraction113.m. V2 is used
...
filename=['MHWOccurrence_SizeFraction_113_v2.csv'];
