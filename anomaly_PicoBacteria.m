...
if mean(aver,'omitnan')==0
        ...
        eval([finalaver,'(k)=log10(mean(aver,''omitnan''))']);
            end
end
...
cd('C:\Users\Tz-Chian Chen\OneDrive - Florida State University\CalCOFI\Output\output_micro')
filename=['Anomaly_PicoBacteria_aver10m.csv'];
