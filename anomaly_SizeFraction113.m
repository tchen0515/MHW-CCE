...
if mean(aver0)==0
        ...
        eval([finalaver1,'(:,k)=log10(mean(aver0,"omitnan"))']);
end
end
...
if mean(aver1)==0
        ...
        eval([finalaver2,'(:,k)=log10(mean(aver1,"omitnan"))']);
end
end
...
if mean(aver2)==0
        ...
        eval([finalaver3,'(:,k)=log10(mean(aver2,"omitnan"))']);
end
end
...
if mean(aver3)==0
        ...
        eval([finalaver4,'(:,k)=log10(mean(aver3,"omitnan"))']);
end
end
...
if mean(aver4)==0
        ...
        eval([finalaver5,'(:,k)=log10(mean(aver4,"omitnan"))']);
end
end
...
if mean(aver5)==0
        ...
        eval([finalaver6,'(:,k)=log10(mean(aver5,"omitnan"))']);
end
end
...
if mean(aver6)==0
        ...
        eval([finalaver7,'(:,k)=log10(mean(aver6,"omitnan"))']);
end
end
...
if mean(aver7)==0
        ...
        eval([finalaver8,'(:,k)=log10(mean(aver7,"omitnan"))']);
end
end
...
if mean(aver8)==0
        ...
        eval([finalaver9,'(:,k)=log10(mean(aver8,"omitnan"))']);
end
end
...
if mean(aver9)==0
        ...
        eval([finalaver10,'(:,k)=log10(mean(aver9,"omitnan"))']);
end
end
...
filename=['Anomaly_SizeFraction_113_v2.csv']; % do not overwrite the version 1
