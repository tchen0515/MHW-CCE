%%% Find the highest negative Chla anomaly for every grid in each MHW event (redo: 2023/11/05)
clear all
close all
...
select_chla=chlaana(targetrow,targetcol,page);
...
filename='MHWOccurrence_negmostChla.csv';
