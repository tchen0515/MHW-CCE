...
mhwmag=readtable('Statistical_MHWbio_reborn.xlsx','UseExcel',true,'Sheet','Intensity');
mhwdur=readtable('Statistical_MHWbio_reborn.xlsx','UseExcel',true,'Sheet','Duration');
mhwtro=readtable('Statistical_MHWbio_reborn.xlsx','UseExcel',true,'Sheet','Trophic');

% seperate bio-indexes by taxa
phytomag=mhwmag([21 23 24 1:5 11:13 18 19 17 20],:); % exclude satellite NPP & reorder taxa
zoomag=mhwmag([35 25:28 31 30 29 32:34 36:39],:); % only select specific taxa 
phytodur=mhwdur([21 23 24 1:5 11:13 18 19 17 20],:);  
...
x1=reordercats(x1,{'SatelliteChla-negmost','IntChla','IntPP',...
...
set(gca,'fontsize', 11,'fontweight','bold','xticklabel',{'SatelliteChla','VerIntChla','VerIntPP',...
...
yticks([-0.4:0.2:0.4])
ylabel("Rho")
title('(a) MHW intensity versus Short-lived microbes');
...
b2=bar(x2,y2);
b2.CData(pval2,:)=[1 0 0; 1 0 0];
b2.FaceColor='flat';
set(gca,'fontsize', 11,'fontweight','bold','xticklabel',{'ZDV','Calanoid','Eucalanids','Harpacticoida','Poecilostomatoids',...
...
x3=reordercats(x3,{'SatelliteChla-negmost','IntChla','IntPP',...
'absChlalow1um','absChla1-3um','absChla3-8um','absChla8-20um','absChlaLarger20um',...
'Divinyl Chla','Fucoxanthin','Hexanoyloxyfucoxanthin',...
'Prochlorococcus','Synechococcus','HeteroBacteria','Picoeukaryotes'}); 
y3=phytodur.Rho;
...
b3=bar(x3,y3);
b3.FaceColor='flat';
b3.CData(pval3,:)=[1 0 0;1 0 0;1 0 0]; % hue (confirm the length of pval)
set(gca,'fontsize', 11,'fontweight','bold','xticklabel',{'SatelliteChla','VerIntChla','VerIntPP',...
    'Chla<1um','Chla1-3um','Chla3-8um','Chla8-20um','Chla>20um',...
      'Divinyl Chla','Fucoxanthin','Hexanoyloxyfucoxanthin',...
    'Prochlorococcus','Synechococcus','HeteroBacteria','Picoeukaryotes'})
...
b4=bar(x4,y4);
b4.FaceColor='flat';
b4.CData(pval4,:)=[1 0 0;1 0 0;1 0 0]; % hue (confirm the length of pval)
set(gca,'fontsize', 11,'fontweight','bold','xticklabel',{'ZDV','Calanoid','Eucalanids','Harpacticoida','Poecilostomatoids',...
    'Oithona-like','Nauplii','Euphausiids','Pyrosomes','Salps','Doliolids',...
    'Sardine Egg','Anchovy Egg','Sardine Larvae','Anchovy Larvae'});
yline(0,'linew',2)
