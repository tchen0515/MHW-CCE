%%%calculate the trapezoidal vertical integration of log10 Chla (original unit:mgC*l^-1) in each Line-Station in Chla data
%%% extracted Chla data compiled from clean_Chla.m 
close all
clear all
