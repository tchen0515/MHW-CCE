...
hplc = readtable('v2_Anomaly_HPLC.csv',VariableNamingRule='preserve')   % data generated by (std)anomaly_HPLC.csv
...
filename=['v2_MHWOccurrence_HPLC.csv'];  % alter the "std" if you run for the original anomaly
