...
addpath 'C:\Users\USER\OneDrive - Florida State University\CalCOFI\output\output_micro\'
pico = readtable('v2_Anomaly_PicoBacteria_aver10m.csv',VariableNamingRule='preserve')  % data generated by (std)anomaly_PicoBacteria.csv
...
filename=['v2_MHWOccurrence_PicoBacteria_aver10m.csv']; % alter the "std" if you run for the original anomaly
