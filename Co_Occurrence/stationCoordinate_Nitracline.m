%%% check the co-occurrence of MHW and YJ-transformed Nitracline
close all
clear all
...
% import targeted file 
 ...
 nitra = readtable('Anomaly_Nitracline.csv',VariableNamingRule='preserve')  % data generated by (std)anomaly_Nitracline.m
...
filename=['MHWOccurrence_Nitracline.csv'];  % alter the "std" if you run for the original anomaly
writetable(nitrafinal,filename);