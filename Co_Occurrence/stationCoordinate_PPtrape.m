...
pp = readtable('v2_Anomaly_PP_Trapezoid.csv',VariableNamingRule='preserve')  % % data generated by (std)anomaly_PP.m
...
filename=['v2_MHWOccurrence_PP_Trapezoid.csv'];  % alter the "std" if you run for the original anomaly
